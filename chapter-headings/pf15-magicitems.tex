...
\input{magic-items/armor}
\input{magic-items/weapons}
\input{magic-items/potions}
\input{magic-items/rings}
\input{magic-items/rods}
\input{magic-items/staves}
\input{magic-items/wands}
\input{magic-items/wonderousItems}
\input{magic-items/intelligentItems}
\input{magic-items/cursedItems}
\input{magic-items/specificCursedItems}
\input{magic-items/artifacts}
\input{magic-items/magicItemCreation}
