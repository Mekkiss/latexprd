\documentclass[10pt,twoside,twocolumn,openany,final]{memoir}
...
\input{chapter-headings/pf02-races}
\input{chapter-headings/pf03-classes}
\input{chapter-headings/pf04-skills}
\input{chapter-headings/pf05-feats}
\input{chapter-headings/pf06-equipment}
\input{chapter-headings/pf07-additionalRules}
\input{chapter-headings/pf08-combat}
\input{chapter-headings/pf09-magic}
\input{chapter-headings/pf10a-spelllist}
\input{chapter-headings/pf10b-spells}
\input{chapter-headings/pf11-prestigeclasses}
\input{chapter-headings/pf12-gamemastering}
\input{chapter-headings/pf13-environment}
\input{chapter-headings/pf14-creating-npcs}
\input{chapter-headings/pf15-magicitems}
\input{chapter-headings/appendix1}
%\end{multicols}
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\appendix
